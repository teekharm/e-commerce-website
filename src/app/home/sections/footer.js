export default function Footer() {
  return (
    <div className="w-full h-max bg-black mt-10">
      ...
      <div className="flex flex-col lg:flex-row lg:gap-50 py-8 px-6 md:flex-row gap:4  mt-8 justify-center">
        ...
        <div className="text-white flex flex-col gap-3 pb-8 lg:pb-0 text-sm lg:font-extralight">
          ...
          <p>
            Sign up to get the latest on sales, new releases <br></br>and more …
          </p>
          <input
            type="text"
            placeholder="Email"
            className="py-2 px-5 bg-white text-black rounded-md placeholder-gray-500"
          ></input>
          <input
            type="text"
